    ...
    <div class="container">
        ...
        <div class="info" style="margin-top: 1%;">
            <div class="row" style="margin-bottom: 3px;">
                <div style="width: 34%; text-align: left;">
                    <p><b>GRN #:</b> <span>{{ $grnMaster->id }}</span></p>
                </div>
                <div style="width: 34%; text-align: left;">
                    <p><b>Purchase Order #:</b> <span>{{ $grnMaster->purchase_order_no }}</span></p>
                </div>
            ...
            <div class="row" style="margin-bottom: 3px;">
                ...
                <div style="width: 30%; text-align: right;">
                    <p><b>Fare:</b> <span>{{ $grnMaster->fare }}</span></p>
                </div>
            </div>
            <div class="row" style="margin-bottom: 3px;">
                <div style="width: 70%; text-align: left;">
                    <p><b>Supplier Bill#:</b> <span>{{ $grnMaster->supplier_bill_no }}</span></p>
                </div>
                <div style="width: 30%; text-align: right;">
                    <p><b>Unloaded By:</b> <span>{{ $grnMaster->unloaded_by }}</span></p>
                </div>
            </div>
            <div class="row" style="margin-bottom: 3px;">
                <div style="width: 70%; text-align: left;">
                ...
                <tbody>
                    @foreach ($grnDetails as $grnDetail)
                        <tr>
                            ...
                            <td>{{ $products[$grnDetail->product_id] }}</td>
                            <td>{{ $grnDetail->packing_type }}</td>
                            <td>{{ $grnDetail->measurement_type }}</td>
                            <td>{{ $grnDetail->size }}</td>
                            <td>{{ $grnDetail->bags }}</td>
                            <td>{{ $grnDetail->measurementType }}</td>
                            <td>{{ $grnDetail->received_qty }}</td>
                            <td>{{ $grnDetail->po_quantity }}</td>
                            <td>{{ $grnDetail->balance }}</td>
                            <td>{{ $grnDetail->detail_remarks }}</td>
        ...
        <div class="row" style="display: flex;">
            <div class="notes" style="width: 70%;">
                <div>
                    <p><b>Remarks: </b> {{ $grnMaster->remarks }}</p>
                </div>
            </div>
            ...
            <div class="totals" style="width: 30%;">
                <table>
                    <tbody>
                        <tr>
                            <th>Tot.Qty</th>
                            <td>{{ $grnMaster->total_quantity ?? '0' }}</td>
                        </tr>
