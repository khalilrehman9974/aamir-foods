<x-base-layout :scrollspy="false">
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Assign Areas</li>
                                <li class="breadcrumb-item"><a href="{{ route('assignArea.list') }}">List</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                <div class="col-lg-0 col-6 ">
                    <a href="{{ route('assignArea.create') }}" class="btn btn-primary mt-2 mb-2 me-8"
                ...
                <div class="widget-content widget-content-area">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach ($assignAreas as $assignArea)
                                    <tr id="row_{{ $assignArea->id }}">
                                        <td>
                                            <div class="media">
                                                <div class="media-body align-self-center">
                                                    <h6 class="mb-0">{{ $assignArea->id }}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="media">
                                                <div class="media-body align-self-center">
                                                    <h6 class="mb-0">{{ $assignArea->sale_man->name }}</h6>
                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="media-body align-self-center">
                                                    <h6 class="mb-0">{{ $assignArea->area_id}}</h6>
                                        ...
                                        <td class="text-center">
                                            <div class="action-btns">
                                                @if ((!empty($permission->edit_access) && $permission->edit_access == 1) || Auth::user()->is_admin == 1)
                                                    <a href="{{ route('assignArea.edit', ['id' => $assignArea->id]) }}"
                                                ...
                                                @if ((!empty($permission->delete_access) && $permission->delete_access == 1) || Auth::user()->is_admin == 1)
                                                    <a href="javascript:void(0)"
                                                        ...
                                                        data-id="{{ $assignArea ->id }}" data-toggle="tooltip"
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-end">
                            {!! $assignAreas->appends(request()->query())->links() !!}
                        </ul>
                    </nav>
                </div>
    ...
    <x-slot:footerFiles>
        ...
        <script>
            var config = {
                routes: {
                    deleteMainHead: "{{ url('assignArea/delete') }}",
                },
            }
        </script>
    </x-slot>
