    ...
    <div class="container">
        <div class="header flex justify-between items-center p-4 border-b border-black">
            ...
            <div class="text-right">
                <p>ABF: S/M-01</p>
                <p class="font-bold text-xl">Sale Order</p>
            </div>
        </div>
        ...
        <div class="info" style="margin-top: 1%;">
            <div class="row" style="margin-bottom: 3px;">
                <div style="width: 70%; text-align: left;">
                    <p><b>Sale Order Number:</b> <span>{{ $saleOrder->id }}</span></p>
                </div>
            ...
            <div class="row" style="margin-bottom: 3px;">
                ...
                <div style="width: 30%; text-align: right;">
                    <p><b>Status:</b> <span>{{ $saleOrder->status }}</span></p>
                </div>
            </div>
        </div>
                ...
                <tbody>
                    @foreach ($saleOrderDetails as $saleOrderDetail)
                        <tr>
                            ...
                            <td>{{ $products[$saleOrderDetail->product_id] }}</td>
                            <td>{{ $saleOrderDetail->packing_type }}</td>
                            <td>{{ $saleOrderDetail->measurement_type }}</td>
                            <td>{{ $saleOrderDetail->quantity }}</td>
                            <td>{{ $saleOrderDetail->dzn }}</td>
                            <td>{{ $saleOrderDetail->total_dzn }}</td>
                            <td>{{ $saleOrderDetail->rate }}</td>
                            <td>{{ $saleOrderDetail->amount }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
        ...
        <div class="row" style="display: flex;">
            <div class="notes" style="width: 50%;">
                <div>
                    <p><b>Remarks: </b> {{ $saleOrder->remarks }}</p>
                </div>
            </div>
            <div class="totals" style="width: 20%;">
                <table>
                    <tbody>
                        <tr>
                            <th>Tot.Carton</th>
                            <td>{{ $saleOrder->total_carton ?? '0' }}</td>
                        </tr>
                        <tr>
                            <th>Tot.Boray</th>
                            <td>{{ $saleOrder->total_boray ?? '0'}}</td>
                        </tr>
            ...
            <div class="totals" style="width: 30%;">
                <table>
                    <tbody>
                        ...
                        <tr >
                            <th>Tot.Amount</th>
                            <td ><b>{{ $saleOrder->total_amount.'.00' ?? '0'}}</b></td>
                        </tr>
                    </tbody>
                </table>
            </div>
