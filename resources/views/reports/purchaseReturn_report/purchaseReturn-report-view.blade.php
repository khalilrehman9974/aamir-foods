...
<head>
    ...
    <title>Purchase Return Invoice Report</title>
        ...
        @foreach ($orders as $order)
            <div class="order-block">
                ...
                <div class="header-info-container">
                    <div class="mb-1">
                        <div class="label-value-pair">
                            <span class="label">PRI#/Date:</span>
                            <span
                                class="value">PRI-{{ $order->id }}({{ optional($order->date) ? \Carbon\Carbon::parse($order->date)->format('d-F-Y') : '' }})</span>
                        </div>
                    </div>
                    ...
                    <div class="mb-1">
                        <div class="label-value-pair">
                            <span class="label">PI#/Date:</span>
                            <span
                                class="value">PI-{{ $order->purchase_invoice_no ?? 'purchase_invoice_no' }}({{ optional($order->purchase_masters)->date ? \Carbon\Carbon::parse($order->purchase_masters->date)->format('d-F-Y') : '' }})</span>
                        </div>
                    </div>
