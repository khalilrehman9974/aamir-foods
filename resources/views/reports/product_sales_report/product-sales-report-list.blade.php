                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="select2 form-control mb-3 custom-select" name="price_tag[]"
                                            ...
                                            @foreach ($dropDownData['priceTags'] as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ (old('price_tag') == $key ? 'selected' : '') || (!empty($contract->price_tag) ? collect($contract->price_tag)->contains($key) : '') ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="select2 form-control mb-3 custom-select" name="level_4[]"
                                            ...
                                            @foreach ($dropDownData['fourthHeads'] as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ (old('level_4') == $key ? 'selected' : '') || (!empty($contract->level_4) ? collect($contract->level_4)->contains($key) : '') ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
