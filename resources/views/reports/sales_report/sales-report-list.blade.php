                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <select class="select2 form-control mb-3 custom-select" name="delivered_to"
                                            id="delivered_to" style="width: 100%; height:36px;">
                                            <option value="">Select</option>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select class="select2 form-control mb-3 custom-select" name="country_id"
                                                id="country" style="width: 100%; height:36px;">
                                                <option value="">Select</option>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select class="select2 form-control mb-3 custom-select" name="zone_id"
                                                id="zone_id" style="width: 100%; height:36px;">
                                                <option value="">Select</option>
