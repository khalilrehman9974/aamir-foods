...
<body class="bg-white text-black text-sm mono p-2">
    ...
    <div class="pagination-wrapper mt-4">
        {{ $purchaseOrderMasters->links('pagination::tailwind') }}
    </div>
    ...
    <div class="print-container w-full mx-auto">
                ...
                <div class="flex gap-2">
                    ...
                    <div style="width: 27% !important">
                        <table class="w-full text-sm">
                            <tbody>
                                <tr>
                                    <td style="width: 5% !important"><b>Gross Amount</b></td>
                                    <td class="text-right" style="width: 10% !important">
                                        <b>{{ $order->gross_total ?? '-' }}</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td><b>Tax</b></td>
                                    <td class="text-right"><b>{{ number_format($order->tax_amount ?? 0, 2) }}</b></td>
                                </tr>
                                <tr>
                                    <td><b>Shipping Amount</b></td>
                                    <td class="text-right"><b>{{ number_format($order->shipping_amount ?? 0, 2) }}</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td><b>Other Amount</b></td>
                                    <td class="text-right"><b>{{ number_format($order->other_amount ?? 0, 2) }}</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td><b>Net Amount</b></td>
                                    <td class="text-right"><b>{{ number_format($order->total_amount ?? 0, 2) }}</b>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
        ...
        <table class="mt-2 text-sm border" style="width: 50% !important">
            <thead>
                ...
                <tr>
                    <th class="bg-gray-200">Total Net Amount</th>
