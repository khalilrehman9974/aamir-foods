                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Bill Aging Report</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div id="tableCustomBasic" class="col-lg-12 col-12 layout-spacing">
            <div class="row">
                <div class="col-lg-12" style="margin-right: 0px !important;">
                    <form action="{{ route('billAging.print') }}" method="get" id="form-search"
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <select class="select2 form-control mb-3 custom-select" name="saleMan_id[]"
                                            id="saleMan_id" style="width: 100%; height:36px;" multiple>
                                            <option value="">Select</option>
