                ...
                <div class="col-md-12 mb-4">
                    <div class="widget-content widget-content-area">
                        <form
                                ...
                                <div class="row">
                                    <div class="col-lg-0 col-6 ">
                                        ...
                                        <input type="text"
                                            ...
                                            id="date" name="date" placeholder="Select The Date" readonly>
                                    </div>
                                    <div class="col-lg-0 col-6 ">
                            ...
                            <div class="form-group">
                                <a href="{{ route('defective.list') }}" style="float: right;"
    ...
    <script>
        document.getElementsByClassName('additem')[0].addEventListener('click', function() {
            ...
            let $html = '<tr>' +
                ...
                currentIndex +
                '"> <option selected="">Please select the Departments</option>@foreach ($dropDownData['departments'] as $key => $value) <option value="{{ $key }}"{{ (old('from_department') == $key ? 'selected' : '') || (!empty($purchaseOrder->from_department) ? collect($purchaseOrder->from_department)->contains($key) : '') ? 'selected' : '' }}>{{ $value }}</option>@endforeach</select> ' +
