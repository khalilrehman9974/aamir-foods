                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('defective.list') }}">List</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                <div class="col-lg-0 col-6 ">
                    <a href="{{ route('defective.create') }}" class="btn btn-primary mt-2 mb-2 me-8"
            ...
            <div class="col-lg-12" style="margin-right: 0px !important;">
                <form class="form-inline my-2 my-lg-0 justify-content-center" method="get"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 ">
                            <span class="input-group-prepend" style="margin-top: 0px;">
                                <a href="{{ route('defective.list') }}" class="btn btn-primary" value="Search"
        ...
        <div id="tableCustomBasic" class="col-lg-12 col-12">
            <div class="statbox widget box box-shadow">
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>List Of Defective Items</h4>
                        </div>
                    </div>
                </div>
                <div class="widget-content widget-content-defective">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col"> <b>Entered By </b> </th>
                                    <th class="text-center" scope="col"></th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($defectiveItems as $defectiveItem)
                                    <tr id="row_{{ $defectiveItem->id }}">
                                        <td>
                                            <div class="media">
                                                <div class="media-body align-self-center">
                                                    <h6 class="mb-0">{{ $defectiveItem->id }}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="media-body align-self-center">
                                                    <h6 class="mb-0">
                                                        {{ \Carbon\Carbon::parse($defectiveItem->date)->format('d-m-Y') }}
                                                    </h6>
                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="media-body align-self-center">
                                                    <h6 class="mb-0">{{ $defectiveItem->entered_by }}</h6>
                                        ...
                                        <td class="text-center">
                                            <div class="action-btns">
                                                <a href="{{ route('defective.edit', ['id' => $defectiveItem->id]) }}"
                                                ...
                                                <a href="{{ route('defective.print', ['id' => $defectiveItem->id]) }}"
                                                ...
                                                {{-- <a href="javascript:void(0);"
                                                    ...
                                                    data-id="{{ $defectiveItem->id }}" data-toggle="tooltip"
                    ...
                    <nav aria-label=" ListPagination">
                        <ul class="pagination justify-content-end">
                            {!! $defectiveItems->appends(request()->query())->links() !!}
                        </ul>
                    </nav>
                </div>
            </div>
