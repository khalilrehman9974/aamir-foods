<x-base-layout :scrollspy="false">
    ...
    <div class="row layout-top-spacing">
        ...
        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
            <div class="row">
                ...
                <div class="col-lg-0 col-6 ">
                    <a href="{{ route('PackingType.create') }}" class="btn btn-primary mt-2 mb-2 me-8"
                ...
                <div class="widget-content widget-content-area">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" style="width: 70%"> <b>Packing Type </b> </th>
                                    <th class="text-center" scope="col"></th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($packingTypes as $packingType)
                                    <tr id="row_{{ $packingType->id }}">
                                        <td>
                                            <div class="media">
                                                <div class="media-body align-self-center">
                                                    <h6 class="mb-0 text-center">{{ $packingType->id }}</h6>
                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="media-body align-self-center">
                                                    <h6 class="mb-0">{{ $packingType->name }}</h6>
                                        ...
                                        <td class="text-center">
                                            <div class="action-btns">
                                                @if ((!empty($permission->edit_access) && $permission->edit_access == 1) || Auth::user()->is_admin == 1)
                                                    <a href="{{ route('PackingType.edit', ['id' => $packingType->id]) }}"
                                                ...
                                                @if ((!empty($permission->delete_access) && $permission->delete_access == 1) || Auth::user()->is_admin == 1)
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        data-toggle="tooltip" data-id="{{ $packingType->id }}"
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-end">
                            {!! $packingTypes->appends(request()->query())->links() !!}
                        </ul>
                    </nav>
                </div>
    ...
    <x-slot:footerFiles>
        ...
        <script>
            var config = {
                routes: {
                    deleteMainHead: "{{ url('PackingType/delete') }}",
                },
            }
        </script>
    </x-slot>
