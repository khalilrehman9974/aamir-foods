                                                ...
                                                <form
                                                    ...
                                                    <div class="form-group input-group ">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input id="area" type="text"
                                                                        name="area"
                                                                        value="{{ old('area', !empty($detailAccount->area) ? $detailAccount->area : '') }}"
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <select id="product" name="product_id"
                                                                        ...
                                                                        @foreach ($dropDownData['products'] as $key => $value)
                                                                            <option value="{{ $key }}"
                                                                                {{ (old('product_id') == $key ? 'selected' : '') || (!empty($detailAccount->product_id) ? collect($detailAccount->product_id)->contains($key) : '') ? 'selected' : '' }}>
                                                                                {{ $value }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-0 col-12 form-group mb-4">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label for="inputState" class="form-label">Price
                                                                    </label>
                                                                    <input id="price" type="text"
                                                                        name="price"
                                                                        value="{{ old('price', !empty($detailAccount->price) ? $detailAccount->price : '') }}"
                                                        ...
                                                        <div class="col-lg-0 col-12 form-group mb-4">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <label for="inputState"
                                                                        class="form-label">Commision
                                                                    </label>
                                                                    <input id="commision" type="text"
                                                                        name="commision"
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="custom-radio">
                                                                            <input type="radio" id="Secondary"
                                                                                name="mode" value="secondary" {{ old('mode', $detailAccount) == 'secondary' ? 'checked' : '' }}>
                                                                            <label for="Secondary">
                                                                                <span class="radio-btn"></span>
                                                                                Secondary
                                                                            </label>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="custom-radio2">
                                                                            <input type="radio" id="active"
                                                                                name="status" value="active" {{ old('status', $detailAccount) == 'active' ? 'checked' : '' }}>
                                                                            <label for="active">
                                                                                <span class="radio-btn"></span>
                                                                                Active
                                                                            </label>
                                                                        ...
                                                                        <div class="custom-radio2">
                                                                            <input type="radio" id="dead"
                                                                                name="status" value="dead"  {{ old('status', $detailAccount) == 'dead' ? 'checked' : '' }}>
                                                                            <label for="dead">
                                                                                <span class="radio-btn"></span>
                                                                                Dead
                                                                            </label>
