                                            ...
                                            <div class="col-lg-6 col-12 ">
                                                <form
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-lg-0 col-12">
                                                            ...
                                                            <select id="main-head" name="main_head" class="form-select" required>
                                                                ...
                                                                @foreach($mainHeads as $index=>$value)
                                                                    <option value="{{ $index }}" {{ (old("main_head") == $index ? "selected":"") || (!empty($controlHead->main_head) ? collect($controlHead->main_head)->contains($index) : '') ? 'selected':'' }}>{{ $value }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <br>
                                                        <div class="col-lg- 0 col-12 ">
                                                            <label for="account_code" class="form-label">Control Account Code</label>
                                                            <input id="account_code" type="text" name="account_code"
                                                                   value="{{ old('account_code', !empty($controlHead->account_code) ? $controlHead->account_code : '') }}"
                                                        ...
                                                        <br>
                                                        <div class="col-lg-0 col-12 ">
                                                            <label for="account_name" class="form-label">Control Account Name </label>
                                                            <input id="account_name" type="text" name="account_name"
                                                                   value="{{ old('account_name', !empty($controlHead->account_name) ? $controlHead->account_name : '') }}"
                                                        ...
                                                        @endif
                                                        <a href="{{ route('control-head.list') }}"
...
{{--            <script src="{{asset('js/common.js')}}"></script>--}}
            ...
            <script>
                ...
                $('#main-head').on('change', function () {
                    ...
                    let url = "{{ url('control-head/get-control-head-account') }}" + '/' + mainCode;
                    $.ajax({
                        url : url,
                        type : 'GET',
                        headers: {
