            ...
            <x-slot:scrollspyConfig>
                ...
                <div class="row layout-top-spacing">
                    ...
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <div class="row">
                                ...
                                <div class="page-meta">
                                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Chart of Accounts
                                            </li>
                                            <li class="breadcrumb-item"><a href="{{ route('main-head.list') }}">List</a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                            ...
                            <div class="col-lg-0 col-6 ">
                                <a href="{{ route('main-head.create') }}" class="btn btn-primary mt-2 mb-2 me-8"
                                        ...
                                        @foreach ($mainHeads as $mainHead)
                                            <tr id="row_{{ $mainHead->id }}">
                                                <td>
                                                    <div class="media">
                                                        <div class="media-body align-self-center">
                                                            <h6 class="mb-0">{{ $mainHead->account_code }}</h6>
                                                ...
                                                <td>
                                                    <div class="media">
                                                        <div class="media-body align-self-center">
                                                            <h6 class="mb-0">{{ $mainHead->account_name }}</h6>
                                                ...
                                                <td class="text-center">
                                                    <div class="action-btns">
                                                        @if ((!empty($permission->edit_access) && $permission->edit_access == 1) || Auth::user()->is_admin == 1)
                                                            <a href="{{ route('main-head.edit', ['id' => $mainHead->id]) }}"
                ...
                <x-slot:footerFiles>
                    ...
                    <script>
                        var config = {
                            routes: {
                                deleteMainHead: "{{ url('main-head/delete') }}",
                            },
                        }
                    </script>
                    </x-slot>
