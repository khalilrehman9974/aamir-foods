                                                ...
                                                <form
                                                    ...
                                                    <div class="form-group input-group">
                                                        <div class="col-lg-0 col-12">
                                                            <label for="inputState" class="form-label">Main Account
                                                                Head</label>
                                                            <select id="main-head" name="main_head" class="form-select"
                                                                ...
                                                                @foreach ($mainHeads as $index => $value)
                                                                    <option value="{{ $index }}"
                                                                        {{ (old('main_head') == $index ? 'selected' : '') || (!empty($subHead->main_head) ? collect($subHead->main_head)->contains($index) : '') ? 'selected' : '' }}>
                                                                        {{ $value }}</option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <br>
                                                        <div class="col-lg-0 col-12">
                                                            <label for="inputState" class="form-label">Control Account
                                                                Head</label>
                                                            @if (!empty($subHead))
                                                                <select id="control-head" name="control_head"
                                                                    ...
                                                                    @foreach ($controlHead as $key => $value)
                                                                        <option value="{{ $key }}"
                                                                            {{ !empty($subHead) && $subHead->control_head == $key ? 'selected' : '' }}
                                                        ...
                                                        <br>
                                                        <div class="col-lg- 0 col-12 ">
                                                            <label for="account_code" class="form-label">Sub Account
                                                                Code</label>
                                                        ...
                                                        <br>
                                                        <div class="col-lg-0 col-12 ">
                                                            <label for="account_name" class="form-label">Sub Account
                                                                Name </label>
