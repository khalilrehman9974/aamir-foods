            ...
            <x-slot:scrollspyConfig>
                                ...
                                <div class="page-meta">
                                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="{{ route('sub-head.list') }}">{{ $pageTitle }}</a></li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                            <div class="col-lg-0 col-6 ">
                                <a href="{{ route('sub-head.create') }}" class="btn btn-primary mt-2 mb-2 me-8"
                ...
                <div class="row layout-top-spacing">
                    <div id="tableCustomBasic" class="col-lg-12 col-12 layout-spacing">
                        <div class="col-lg-8 col-md-8 col-sm-9 filtered-list-search mx-auto">
                            <form method="get" action="{{ route('sub-head.list') }}" class="form-inline my-2 my-lg-0 justify-content-center">
                                <div class="w-100">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col" style="width: 20%"> <b>Control Head Account </b> </th>
                                            <th scope="col" style="width: 20%"> <b>Account Code </b> </th>
                                            <th scope="col" style="width: 30%"> <b>Sub Head Account Name </b> </th>
                                                ...
                                                <td class="text-center">
                                                    <div class="action-btns">
                                                        @if ((!empty($permission->edit_access) && $permission->edit_access == 1) || Auth::user()->is_admin == 1)
                                                            <a href="{{ route('sub-head.edit', ['id' => $head->id]) }}"
                ...
                <x-slot:footerFiles>
                    ...
                    <script>
                        var config = {
                            routes: {
                                deleteMainHead: "{{ url('sub-head/delete') }}",
                            },
                        }
                    </script>
                    </x-slot>
