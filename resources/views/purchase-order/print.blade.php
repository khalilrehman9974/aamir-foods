        ...
        <div class="info" style="margin-top: 1%;">
            <div class="row" style="margin-bottom: 3px;">
                <div style="width: 70%; text-align: left;">
                    <p><b>Purchase Order #:</b> <span>{{ $purchaseOrder->id }}</span></p>
                </div>
            ...
            <div class="row" style="margin-bottom: 3px;">
                ...
                <div style="width: 30%; text-align: right;">
                    <p><b>Contact Person:</b> <span>{{ $purchaseOrder->contact_person }}</span></p>
                </div>
            </div>
            <div class="row" style="margin-bottom: 3px;">
                <div style="width: 70%; text-align: left;">
                    <p><b>Status:</b> <span>{{ $purchaseOrder->status }}</span></p>
                </div>
            </div>
                ...
                <tbody>
                    @foreach ($purchaseOrderDetails as $purchaseOrderDetail)
                        <tr>
                            ...
                            <td>{{ $products[$purchaseOrderDetail->product_id] }}</td>
                            <td>{{ $purchaseOrderDetail->packing_type }}</td>
                            <td>{{ $purchaseOrderDetail->measurement_type }}</td>
                            <td>{{ $purchaseOrderDetail->size }}</td>
                            <td>{{ $purchaseOrderDetail->quantity }}</td>
                            <td>{{ $purchaseOrderDetail->price }}</td>
                            <td>{{ $purchaseOrderDetail->amount }}</td>
                            <td>{{ $purchaseOrderDetail->detail_remarks }}</td>
            ...
            <div class="totals" style="width: 30%;">
                <table>
                    <tbody>
                        <tr>
                            <th>Gross.Amount</th>
                            <td>{{ $purchaseOrder->gross_total ?? '0' }}</td>
                        </tr>
                        <tr>
                            <th>Tax.Amount</th>
                            <td>{{ $purchaseOrder->tax_amount ?? '0'}}</td>
                        </tr>
                        <tr>
                            <th>Shipping.Amount</th>
                            <td>{{ $purchaseOrder->shipping_amount ?? '0'}}</td>
                        </tr>
                        <tr>
                            <th>Other.Amount</th>
                            <td>{{ $purchaseOrder->other_amount ?? '0'}}</td>
                        </tr>
                        <tr>
                            <th>Tot.Amount</th>
                            <td>{{ $purchaseOrder->total_amount ?? '0'}}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
