                                            ...
                                            <div class="col-xl-0 col-lg-12">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group mt-3">
                                                        ...
                                                        <select id="subcategory" class="form-control select2" name="subcategory"
                                                            multiple>
                                                    ...
                                                    <div class="form-group mt-3">
                                                        ...
                                                        <select id="variation" class="form-control select2" name="variation"
                                                            multiple>
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        $('#category').change(function() {
                            ...
                            $('#variation').html('<option value="">Select Variation</option>');
