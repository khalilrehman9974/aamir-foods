<x-base-layout :scrollspy="false">
    ...
    <div class="row layout-top-spacing">
        ...
        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
            <div class="row">
                ...
                <div class="col-lg-0 col-6 ">
                    <a href="{{ route('saleMan.create') }}" class="btn btn-primary mt-2 mb-2 me-8"
        ...
        <div id="tableCustomBasic" class="col-lg-12 col-12">
            <div class="statbox widget box box-shadow">
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>List Of Sale Mans</h4>
                        </div>
                    </div>
                </div>
                <div class="widget-content widget-content-saleMan">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach ($saleMans as $saleMan)
                                    <tr id="row_{{ $saleMan->id }}">
                                        <td>
                                            <div class="media">
                                                <div class="media-body align-self-center">
                                                    <h6 class="mb-0">{{ $saleMan->id }}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            <div class="action-btns">
                                                @if ((!empty($permission->edit_access) && $permission->edit_access == 1) || Auth::user()->is_admin == 1)
                                                    <a href="{{ route('saleMan.edit', ['id' => $saleMan->id]) }}"
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-end">
                            {!! $saleMans->appends(request()->query())->links() !!}
                        </ul>
                    </nav>
                </div>
    ...
    <x-slot:footerFiles>
        ...
        <script>
            var config = {
                routes: {
                    deleteMainHead: "{{ url('saleMan/delete') }}",
                },
            }
        </script>
    </x-slot>
