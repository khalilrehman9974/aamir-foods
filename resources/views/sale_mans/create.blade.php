            ...
            <div class="statbox widget box box-shadow">
                ...
                <div class="container">
                    ...
                    <div class="widget-content widget-content-area">
                        <form method="POST"
                            action="{{ !empty($saleMan_id) ? route('saleMan.update') : route('saleMan.save') }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-0 col-12 ">
                                    ...
                                    <textarea id="mailing_address" type="textarea" name="mailing_address" rows="3"
                                        value="{{ isset($saleMan->mailing_address) ? $saleMan->mailing_address : '' }}"
                                        placeholder="Please Enter Mailing Address" class="form-control">{{ @$saleMans->mailing_address }} </textarea>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea type="textarea" id="address" name="address" value="{{ isset($saleMan->address) ? $saleMan->address : '' }}"
                                            class="form-control" required>{{ @$saleMan->address }}</textarea>
                                        @error('address')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
