    ...
    <div class="row layout-top-spacing">
        ...
        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
            <div class="row">
                ...
                <div class="col-lg-0 col-6 ">
                    <a href="{{ route('product.create') }}" class="btn btn-primary mt-2 mb-2 me-8"
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" scope="col"><b>Purchase Price </b></th>
                                    <th class="text-center" scope="col"><b>Sale Price</b></th>
                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="media-body align-self-center">
                                                    ...
                                                    <h6 class="mb-0">{{ $product->sale_price }}</h6>
                                                </div>
                                            </div>
                                        </td>
