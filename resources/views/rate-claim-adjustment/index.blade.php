<x-base-layout :scrollspy="false">
                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Claim & Rate Adjustments</li>
                                <li class="breadcrumb-item"><a href="{{ route('claim.list') }}">List</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                <div class="col-lg-0 col-6 ">
                    <a href="{{ route('claim.create') }}" class="btn btn-primary mt-2 mb-2 me-8"
                ...
                <div class="col-lg-12" style="margin-right: 0px !important;">
                    <form class="form-inline my-2 my-lg-0 justify-content-center" method="get"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 ">
                                <span class="input-group-prepend" style="margin-top: 0px;">
                                    <a href="{{ route('claim.list') }}" class="btn btn-primary"
                                ...
                                @foreach ($claims as $claim)
                                    <tr id="row_{{ $claim->id }}">
                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="media-body align-self-center">
                                                    <h6 class="mb-0">{{ $claim->party->account_name }}</h6>
                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="media-body align-self-center">
                                                    <h6 class="mb-0">{{ $claim->driver_name}}</h6>
                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="media-body align-self-center">
                                                    <h6 class="mb-0">{{ $claim->gross_amount }}</h6>
                                        ...
                                        <td class="text-center">
                                            <div class="action-btns">
                                                ...
                                                @if ((!empty($permission->edit_access) && $permission->edit_access == 1) || Auth::user()->is_admin == 1)
                                                    <a href="{{ route('claim.edit', ['id' => $claim->id]) }}"
                                                ...
                                                {{-- <a href="javascript:void(0);"
                                                    ...
                                                    data-toggle="tooltip" data-id="{{ $claim->id }}"
    ...
    <x-slot:footerFiles>
        ...
        <script>
            var config = {
                routes: {
                    deleteMainHead: "{{ url('claim/delete') }}",
                },
            }
        </script>
    </x-slot>
