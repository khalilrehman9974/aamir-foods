    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('claim.list') }}">List of Claim & Rate Adjustments</a></li>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6 mt-5">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                value="{{ old('saleman', !empty($claim->saleman) ? $claim->saleman : '') }}"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6 mt-5">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                value="{{ old('sector', !empty($claim->sector) ? $claim->sector : '') }}"
                                                                                placeholder="Belt Name..." readonly>
                                                                        </div>
                                                                        <div class="col-md-6 mt-5">
                                                                            <label for="date">
                                                                                Area</label>
                                                                            <input type="text"
                                                                                ...
                                                                                class="form-control {{ config('constants.css-classes.ELEMENT_SIZE_CLASS') }}"
                                                                                id="area" name="area"
                                                                                value="{{ old('area', !empty($claim->area) ? $claim->area : '') }}"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6 mt-5">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                class="form-control {{ config('constants.css-classes.ELEMENT_SIZE_CLASS') }}"
                                                                                id="sector"
                                                                                value="{{ old('delivered_to', !empty($claim->delivered_to) ? $claim->delivered_to : '') }}"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6 mt-5">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                class="form-control {{ config('constants.css-classes.ELEMENT_SIZE_CLASS') }}"
                                                                                id="transporter"
                                                                                value="{{ old('transporter', !empty($claim->transporter) ? $claim->transporter : '') }}"
                                                                                placeholder="Transporter..." required>
                                                                            @error('transporter')
                                                                                <span style="color:red"
                                                                                    class="invalid-feedback">
                                                                                    <strong>{{ $message }}</strong>
                                                                                            ...
                                                                                            <tr
                                                                                                ...
                                                                                                <td class="product">
                                                                                                    <select
                                                                                                        ...
                                                                                                        class="{{ config('constants.css-classes.ELEMENT_SIZE_CLASS') }} form-control mb-3 product_2 select2 custom-select"
                                                                                                        required>
                                                                                                        <option
                                                                                                            value="">
                                                                                                            Select
                                                                                                        ...
                                                                                                        @foreach ($dropDownData['products'] as $key => $value)
                                                                                                            <option
                                                                                                                value="{{ $key }}"
                                                                                                                {{ (old('product_id') == $key ? 'selected' : '') || (!empty($claim->product_id) ? collect($claim->product_id)->contains($key) : '') ? 'selected' : '' }}>
                                                                                                                {{ $value }}
                                                                                                            </option>
                                                                                                        @endforeach
                                                                                                    </select>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4"
                                                                                ...
                                                                                <input type="text"
                                                                                    style="color: black;"
                                                                                    id="discount-amount"
                                                                                    name="discount" value="{{ old('discount', !empty($claim->discount) ? $claim->discount : '') }}"
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4"
                                                                                ...
                                                                                <input type="text"
                                                                                    ...
                                                                                    name="commission" value="{{ old('commission', !empty($claim->commission) ? $claim->commission : '') }}"
