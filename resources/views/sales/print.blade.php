    ...
    <div class="container">
        ...
        <div class="info" style="margin-top: 1%;">
            <div class="row" style="margin-bottom: 3px;">
                <div style="width: 34%; text-align: left;">
                    <p><b>Sale Order#:</b> <span>{{ $saleMaster->sale_order_number }}</span></p>
                </div>
                <div style="width: 34%; text-align: right;">
                    <p><b> Dispatch Note#:</b> <span>{{ $saleMaster->dispatch_note_number }}</span></p>
                </div>
                <div style="width: 30%; text-align: left;">
                    <p><b>Sale Invoice#:</b> <span>{{ $saleMaster->id }}</span></p>
                </div>
            </div>
            <div class="row" style="margin-bottom: 3px;">
            ...
            <div class="row" style="margin-bottom: 3px;">
                ...
                <div style="width: 30%; text-align: right;">
                    <p><b>Vehicle No:</b> <span>{{ $saleMaster->vehicle_no }}</span></p>
                </div>
            </div>
            <div class="row" style="margin-bottom: 3px;">
                <div style="width: 70%; text-align: left;">
                    <p><b>Driver Name:</b> <span>{{ $saleMaster->driver_name }}</span></p>
                </div>
                <div style="width: 30%; text-align: right;">
                    <p><b>Bilty No:</b> <span>{{ $saleMaster->bilty_no}}</span></p>
                </div>
            </div>
        </div>
                ...
                <tbody>
                    @foreach ($saleDetails as $saleDetail)
                        <tr>
                            ...
                            <td>{{ $saleDetail->dzns }}</td>
                            <td>{{ $saleDetail->total_dzns }}</td>
        ...
        <div class="row" style="display: flex;">
            <div class="notes" style="width: 50%;">
                <div>
                    <p><b>Remarks: </b> {{ $saleMaster->remarks }}</p>
                </div>
            </div>
            <div class="totals" style="width: 20%;">
                <table>
                    <tbody>
                        <tr>
                            <th>Tot.Carton</th>
                            <td>{{ $saleMaster->total_carton ?? '0' }}</td>
                        </tr>
                        <tr>
                            <th>Tot.Boray</th>
                            <td>{{ $saleMaster->total_boray ?? '0'}}</td>
                        </tr>
            ...
            <div class="totals" style="width: 30%;">
                <table>
                    <tbody>
                        ...
                        <tr >
                            <th>Groos.Amount</th>
                            <td ><b>{{ $saleMaster->gross_bill.'.00' ?? '0'}}</b></td>
                        </tr>
                        <tr >
                            <th>Carriage</th>
                            <td ><b>{{ $saleMaster->carriage ?? '0'}}</b></td>
                        </tr>
                        <tr >
                            <th>Tot.Discount</th>
                            <td ><b>{{ $saleMaster->totaldiscount ?? '0'}}</b></td>
                        </tr>
                        <tr >
                            <th>Commission</th>
                            <td ><b>{{ $saleMaster->commission ?? '0'}}</b></td>
                        </tr>
                        <tr >
                            <th>Net.Amount</th>
                            <td ><b>{{ $saleMaster->net_amount ?? '0'}}</b></td>
                        </tr>
                    </tbody>
                </table>
            </div>
