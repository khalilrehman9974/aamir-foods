                                                                        ...
                                                                        <div class="row justify-content-between">
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                ...
                                                                                <div class="form-group mb-4">
                                                                                    ...
                                                                                    <input type="text" class="form-control form-control-sm" id="number" placeholder="">
                                                                                </div>
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                <div class="form-group mb-4">
                                                                                    ...
                                                                                    <input type="text" class="form-control flatpickr-input {{ config('constants.css-classes.ELEMENT_SIZE_CLASS') }}" id="date" placeholder="Add date picker" value="{{ $invoiceNo }}" readonly="readonly">
                                                                                </div>
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                <div class="form-group mb-4">
                                                                                    ...
                                                                                    <input type="text" class="form-control form-control-sm flatpickr-input" id="due" placeholder="None"  readonly="readonly">
                                                                                </div>
...
{{--                                                                                                        value="{{ old('product_id', !empty($saleDetail->product_id) ? $saleDetail->product_id : '') }}"--}}
                                                                            ...
                                                                            <div class="col-xl-5 invoice-address-client invoice-detail-total" style="float: right">
                                                                                <div
                                                                                    class="invoice-address-client-fields">

                                                                                    <div class="form-group row">
                                                                                        <label for="client-name"
                                                                                               class="col-sm-4 col-form-label col-form-label-sm">Gross Bill</label>
                                                                                        <div class="col-sm-8">
                                                                                    ...
                                                                                    <div class="form-group row">
                                                                                        <label for="client-email"
                                                                                               class="col-sm-4 col-form-label col-form-label-sm">- Freight</label>
                                                                                        <div class="col-sm-8">
                                                                                    ...
                                                                                    <div class="form-group row">
                                                                                        <label for="client-address"
                                                                                               class="col-sm-4 col-form-label col-form-label-sm">- Scheme</label>
                                                                                        <div class="col-sm-8">
                                                                                    ...
                                                                                    <div class="form-group row">
                                                                                        <label for="client-phone"
                                                                                               class="col-sm-4 col-form-label col-form-label-sm">- Commission</label>
                                                                                        <div class="col-sm-8">
                                                                                    ...
                                                                                    <div class="form-group row">
                                                                                        <label for="client-phone"
                                                                                               class="col-sm-4 col-form-label col-form-label-sm">Net Amount</label>
                                                                                        <div class="col-sm-8">
                          ...
                          /*  $('.tr_clone').find("select.product_id").next(".select2-container").remove();
                           ...
                           /* let getTableElement = document.querySelector('.item-table');
                            ...
                            @endforeach
                                ...
                                '<td class="rate">' +
                                '<input type="text" class="form-control  form-control-sm qty_' + currentIndex + '" placeholder="Qty"></td>' +
                                '<td class="text-right qty"><input type="text" class="form-control  form-control-sm unit_' + currentIndex + '" placeholder="unit"></td>' +
                                '<td class="text-right amount"><span class="editable-amount"><span class="currency"></span><span class="amount">0.00</span></span></td>' +
                                '<td class="text-right rate"><input type="text" class="form-control  form-control-sm rate_' + currentIndex + ' rate" placeholder="Rate"></td>' +
                                '<td><input type="text" id="amount" name="amount[]" class="form-control form-control-sm amount_' + currentIndex + ' amount" placeholder="Amount" style="width: 210px !important;"></td>' +
                                '</div>' +
                                '</div>' +
                                '</td>' +
                                '</tr>';
