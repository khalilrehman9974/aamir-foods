                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('dispatch-note.list') }}">List</a>
                                </li>
                            </ol>
                        </nav>
                    </div>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" style="width: 20%"><b>Distributer </b></th>
                                ...
                                @foreach ($dispatchNotes as $note)
                                    <tr id="row_{{ $note->id }}">
                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="media-body align-self-center">
                                                    <h6 class="mb-0">{{ $note->product_id }}</h6>
                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="media-body align-self-center">
                                                    <h6 class="mb-0">{{ $note->quantity }}</h6>
                                        ...
                                        <td class="text-center">
                                            <div class="action-btns">
                                                @if ((!empty($permission->edit_access) && $permission->edit_access == 1) || Auth::user()->is_admin == 1)
                                                    <a href="{{ route('main-head.edit', ['id' => $note->id]) }}"
