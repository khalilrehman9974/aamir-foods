                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <select id="party" name="party_id"
                                                                            ...
                                                                            @foreach ($parties as $key => $value)
                                                                                <option value="{{ $key }}"
                                                                                    @php
$isSelected = old('party_id') == $key || $note->pluck('party_id')->contains($key); @endphp
                                                                                    {{ $isSelected ? 'selected' : '' }}>
                                                                                    {{ $value }}
                                                                                </option>
                                                                            @endforeach
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <select id="saleMan" name="saleman"
                                                                            ...
                                                                            @foreach ($saleMans as $key => $value)
                                                                                <option value="{{ $key }}"
                                                                                    @php
$isSelected = old('saleman') == $key || $note->pluck('saleman')->contains($key); @endphp
                                                                                    {{ $isSelected ? 'selected' : '' }}>
                                                                                    {{ $value }}
                                                                                </option>
                                                                            @endforeach
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <select id="sector" name="sector"
                                                                            ...
                                                                            @foreach ($sectors as $key => $value)
                                                                                <option value="{{ $key }}"
                                                                                    @php
$isSelected = old('sector') == $key || $note->pluck('sector')->contains($key); @endphp
                                                                                    {{ $isSelected ? 'selected' : '' }}>
                                                                                    {{ $value }}
                                                                                </option>
                                                                            @endforeach
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <select id="area" name="area"
                                                                            ...
                                                                            @foreach ($areas as $key => $value)
                                                                                <option value="{{ $key }}"
                                                                                    @php
$isSelected = old('area') == $key || $note->pluck('area')->contains($key); @endphp
                                                                                    {{ $isSelected ? 'selected' : '' }}>
                                                                                    {{ $value }}
                                                                                </option>
                                                                            @endforeach
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <select id="delivered_to" name="delivered_to"
                                                                            ...
                                                                            @foreach ($deliveredToParties as $key => $value)
                                                                                <option value="{{ $key }}"
                                                                                    @php
$isSelected = old('delivered_to') == $key || $note->pluck('delivered_to')->contains($key); @endphp
                                                                                    {{ $isSelected ? 'selected' : '' }}>
                                                                                    {{ $value }}
                                                                                </option>
                                                                            @endforeach
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input type="text" style="color: black; "
                                                                            ...
                                                                            value="{{ old('driver_name', !empty($note->driver_name) ? $note->driver_name : '') }}"
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td
                                                                                                ...
                                                                                                <input id="dzn"
                                                                                                    type="text"
                                                                                                    name="dzn[]"
                                                                                                    value="{{ old('dzn', !empty($dispatchNote->dzn) ? $dispatchNote->dzn : '') }}"
                                                                                                    placeholder="Dzn.... "
                                                                                            ...
                                                                                            <td
                                                                                                ...
                                                                                                <input id="total_dzn"
                                                                                                    ...
                                                                                                    style="color: black;"
                                                                                                    name="total_dzn[]"
                                                                                                    value="{{ old('total_dzn', !empty($dispatchNote->total_dzn) ? $dispatchNote->total_dzn : '') }}"
                                                                                                    placeholder="Tot. Dzn.... "
                                                                    ...
                                                                    <div class="avatar me-2"
                                                                        ...
                                                                        @else
                                                                            @foreach ($images as $image)
                                                                                <img alt="avatar"
                                                                                    src="{{ asset('images/dispatchNote/') . '/' . @$image->images }}"
                                                                                    class="rounded-circle" />
                                                                            @endforeach
                                                                        @endif
