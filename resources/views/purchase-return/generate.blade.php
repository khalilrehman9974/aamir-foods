    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Purchase Return Invoice</li>
            </ol>
        </nav>
    </div>
                                        ...
                                        <div class="widget-content widget-content-area">
                                            <div class="row">
                                                <div class="col-lg-12 col-12 ">
                                                    <form class="row g-3" action="{{ route('purchase-return.create') }}" autocomplete="off"
                                                        method="GET">
                                                        {{-- @csrf --}}
                                                        <div id="results">
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label for="inputState" class="form-label">Purchase Invoice No:</label>
                                                                            <input type="text" name="id" id="id" class="form-control {{ config('constants.css-classes.ELEMENT_SIZE_CLASS') }}"
                                                                            placeholder="Please Enter Purchase Invoice Number" required>
