                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-0 col-6 ">
                                                                    ...
                                                                    <input id="grn_no" type="grn_no" name="grn_no"
                                                                        value="{{ old('grn_no', !empty($purchaseReturn->grn_no) ? $purchaseReturn->grn_no : '') }}"
                                                                        placeholder="Please Enter The GRN No "
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-0 col-6 ">
                                                                    ...
                                                                    <input id="bill_no" type="bill_no" name="bill_no"
                                                                        value="{{ old('bill_no', !empty($purchaseReturn->bill_no) ? $purchaseReturn->bill_no : '') }}"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-0 col-6 ">
                                                                    ...
                                                                    <input id="fare" type="fare"
                                                                        name="fare"
                                                                        value="{{ old('fare', !empty($purchaseReturn->fare) ? $purchaseReturn->fare : '') }}"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-0 col-6">
                                                                    ...
                                                                    <input id="carriage_inward" type="text"
                                                                        ...
                                                                        value="{{ old('carriage_inward', !empty($purchaseReturn->carriage_inward) ? $purchaseReturn->carriage_inward : '') }}"
                                                            ...
                                                            <div class="invoice-detail-items">
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table item-table">
                                                                        ...
                                                                        <tbody>
                                                                            @foreach ($purchaseReturnDetails as $purchaseReturn)
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="description">
                                                                                        <select id="product_id"
                                                                                            ...
                                                                                            @foreach ($dropDownData['products'] as $key => $value)
                                                                                                <option
                                                                                                    value="{{ $key }}"
                                                                                                    {{ (old('product_id') == $key ? 'selected' : '') || (!empty($purchaseReturn->product_id) ? collect($purchaseReturn->product_id)->contains($key) : '') ? 'selected' : '' }}>
                                                                                                    {{ $value }}
                                                                                                </option>
                                                                                            @endforeach
                                                                                        </select>
                                    ...
                                    <div class="statbox widget box box-shadow">
                                        <div class="widget-content widget-content-area">
                                            <div class="row">
                                                <div class="col-lg-12 col-12 ">
                                                    <form
                                                        action="{{ !empty($purchase) ? route('purchase-return.update') : route('purchase-return.save') }}"
                                                        method="POST" class="row g-3 needs-validation" novalidate>
                                                        @csrf
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-0 col-4 ">
                                                                    ...
                                                                    <input id="po_no" type="number" name="purchase_order_no" style="color: black"
                                                                        value="{{$purchaseMaster->purchase_order_no}}"
                                                                        placeholder="PO No... "
                                                                        class="form-control {{ config('constants.css-classes.ELEMENT_SIZE_CLASS') }}"
                                                                        required readonly>
                                                                </div>
                                                                <div class="col-lg-0 col-4 ">
                                                                    ...
                                                                    <input id="purchase_invoice_no_" type="text" name="purchase_invoice_no"
                                                                        value="{{$purchaseMaster->id}}" style="color: black"
                                                                ...
                                                                <div class="col-lg-0 col-6 ">
                                                                    ...
                                                                    <select id="party_id" type="text"
                                                                        ...
                                                                        @foreach ($parties as $key => $value)
                                                                            <option value="{{ $key }}"
                                                                                {{ (old('party_id') == $key ? 'selected' : '') || (!empty($purchaseMaster->party_id) ? collect($purchaseMaster->party_id)->contains($key) : '') ? 'selected' : '' }}>
                                                                                {{ $value }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    {{-- <div class="invalid-feedback">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-0 col-6 ">
                                                                    ...
                                                                    <input id="supplier_bill_no" type="text" name="supplier_bill_no"
                                                                        value="{{ old('supplier_bill_no', !empty($purchaseMaster->supplier_bill_no) ? $purchaseMaster->supplier_bill_no : '') }}"
                                                                ...
                                                                <div class="col-lg-0 col-6 ">
                                                                    ...
                                                                    <select id="transporter_id" type="text"
                                                                        ...
                                                                        @foreach ($transporters as $key => $value)
                                                                            <option value="{{ $key }}"
                                                                                {{ (old('transporter_id') == $key ? 'selected' : '') || (!empty($purchaseMaster->transporter_id) ? collect($purchaseMaster->transporter_id)->contains($key) : '') ? 'selected' : '' }}>
                                                                                {{ $value }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    {{-- <div class="invalid-feedback">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-md-6 ">
                                                                    ...
                                                                    <input type="text" name="unloaded_by" style="color: black;"
                                                                        value="{{ old('unloaded_by', !empty($purchaseMaster->unloaded_by) ? $purchaseMaster->unloaded_by : '') }}"
                                                                                    ...
                                                                                    <tr class="tr_clone validator_{{ $index }}">
                                                                                        ...
                                                                                        <td class="product">
                                                                                            <select id="product_id" name="product_id[]"
                                                                                                ...
                                                                                                @foreach ($dropDownData['products'] as $key => $value)
                                                                                                    <option value="{{ $key }}"
                                                                                                        {{ (old('product_id') == $key ? 'selected' : '') || (!empty($purchaseDetail->product_id) ? collect($purchaseDetail->product_id)->contains($key) : '') ? 'selected' : '' }}>
                                                                                                        {{ $value }}
                                                                                                    </option>
                                                                                                @endforeach
                                                                                            </select>
                                                                                        ...
                                                                                        <td class="quantity">
                                                                                            <input type="text" style="color: black;" id="quantity"
                                                                                                value="{{ old('quantity', !empty($purchaseDetail->quantity) ? $purchaseDetail->quantity : '') }}"
                                                                                        ...
                                                                                        <td class="quantity">
                                                                                            <input type="number" id="price"
                                                                                                name="price[]" value="{{ old('price', !empty($purchaseDetail->price) ? $purchaseDetail->price : '') }}"
                                                                                        ...
                                                                                        <td class="quantity">
                                                                                            <input type="text" style="color: black;"
                                                                                                ...
                                                                                                value="{{ old('amount', !empty($purchaseDetail->amount) ? $purchaseDetail->amount : '') }}"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12" style="float: right;">
                                                                        <div style="width: 40%; float: right;">
                                                                            <label for="client-phone">Tot Qty:</label>
                                                                            <input type="text" style="color: black;"
                                                                            id="total_quantity" name="total_quantity" value=" {{$purchaseMaster->total_quantity}} "
                                                                            class="form-control {{ config('constants.css-classes.ELEMENT_SIZE_CLASS') }}"
                                                                            id="client-phone" placeholder="Tot.Qty" readonly>
                                                                    ...
                                                                    <div class="col-md-12 align-self-center">
                                                                        ...
                                                                        <div class="form-group row invoice-note">
                                                                            <label for="invoice-detail-notes"
                                                                                class="col-sm-12 col-form-label col-form-label-sm">Remarks</label>
                                                                            <div class="col-sm-12">
                                                                                <textarea class="form-control" id="remarks" name="remarks" placeholder='Enter The Remarks' style="height: 88px;">{{ @$purchaseMaster->remarks }}</textarea>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4"
                                                                                ...
                                                                                <input type="text"
                                                                                    style="color: black;"
                                                                                    id="tax-amount"
                                                                                    name="tax"  value=" {{ $purchaseMaster->tax }} "
                                                                    ...
                                                                    <div class="col-md-6" style="float: right; ">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4"
                                                                                ...
                                                                                <input type="text"
                                                                                    style="color: black;"
                                                                                    id="net-amount"  value=" {{ $purchaseMaster->net_amount }} "
                                                                                    name="net_amount"
                                                                                    class="form-control {{ config('constants.css-classes.ELEMENT_SIZE_CLASS') }}"
