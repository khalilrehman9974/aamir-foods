    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('purchase-return.list') }}">List of Purchase Returns</a></li>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-12 ">
                                                    <form
                                                        ...
                                                        @csrf
                                                        <input type="hidden" name="purchaseReturnId" id="purchaseReturnId"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-0 col-6 ">
                                                                        ...
                                                                        <select id="party_id" type="text"
                                                                            name="party_id"
                                                                            value="{{ old('party_id', !empty($purchaseReturn->party_id) ? $purchaseReturn->party_id : '') }}"
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-0 col-6 ">
                                                                        ...
                                                                        <select id="transporter_id" type="text"
                                                                            name="transporter_id"
                                                                            value="{{ old('transporter_id', !empty($purchaseReturn->transporter_id) ? $purchaseReturn->transporter_id : '') }}"
