    ...
    <div class="container">
        ...
        <div class="info" style="margin-top: 1%;">
            <div class="row" style="margin-bottom: 3px;">
                <div style="width: 34%; text-align: left;">
                    <p><b>Purchase Order #:</b> <span>{{ $purchasereturnMaster->purchase_order_no }}</span></p>

                </div>
                <div style="width: 34%; text-align: left;">
                    <p><b>Purchase Invoice #:</b> <span>{{ $purchasereturnMaster->purchase_invoice_no }}</span></p>
                </div>
                <div style="width: 30%; text-align: left;">
                    <p><b>Purchase Return Invoice #:</b> <span>{{ $purchasereturnMaster->id }}</span></p>
                </div>
            </div>
            ...
            <div class="row" style="margin-bottom: 3px;">
                <div style="width: 70%; text-align: left;">
                    <p><b>Supplier Bill#:</b> <span>{{ $purchasereturnMaster->supplier_bill_no }}</span></p>
                </div>
                <div style="width: 30%; text-align: right;">
                    <p><b>Unloaded By:</b> <span>{{ $purchasereturnMaster->unloaded_by }}</span></p>
                </div>
            </div>
            <div class="row" style="margin-bottom: 3px;">
                <div style="width: 70%; text-align: left;">
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="width: 10%;">Measurement Type</th>
                ...
                <tbody>
                    @foreach ($purchaseReturnDetails as $purchaseReturnDetail)
                        <tr>
                            ...
                            <td>{{ $products[$purchaseReturnDetail->product_id] }}</td>
                            <td>{{ $purchaseReturnDetail->packing_type }}</td>
                            <td>{{ $purchaseReturnDetail->measurement_type }}</td>
                            <td>{{ $purchaseReturnDetail->size }}</td>
                            <td>{{ $purchaseReturnDetail->bags }}</td>
                            <td>{{ $purchaseReturnDetail->measurementType }}</td>
                            <td>{{ $purchaseReturnDetail->quantity }}</td>
                            <td>{{ $purchaseReturnDetail->price }}</td>
                            <td>{{ $purchaseReturnDetail->amount }}</td>
        ...
        <div class="row" style="display: flex;">
            <div class="notes" style="width: 54%;">
                <div>
                    <p><b>Remarks: </b> {{ $purchasereturnMaster->remarks }}</p>
                </div>
            </div>
            <div class="totals" style="width: 20%;">
                <table>
                    <tbody>
                        <tr>
                            <th>Tot.Qty</th>
                            <td>{{ $purchasereturnMaster->total_quantity ?? '0' }}</td>
                        </tr>
            ...
            <div class="totals" style="width: 26%;">
                <table>
                    <tbody>
                        <tr>
                            <th>Gross.Amount</th>
                            <td>{{ $purchasereturnMaster->gross_bill ?? '0' }}</td>
                        </tr>
                        <tr>
                            <th>Carriage</th>
                            <td>{{ $purchasereturnMaster->carriage ?? '0' }}</td>
                        </tr>
                        <tr>
                            <th>Tax.Amount</th>
                            <td>{{ $purchasereturnMaster->tax ?? '0' }}</td>
                        </tr>
                        <tr>
                            <th>Net.Amount</th>
                            <td>{{ $purchasereturnMaster->net_amount ?? '0' }}</td>
                        </tr>
