...
@php
    // $notificationObj = new \App\Services\NotificationService();
    // $no=  App\Services\NotificationService::class;
    // $data = $no->getData();
    ...
    <header class="header navbar navbar-expand-sm expand-header">
        ...
        <ul class="navbar-item flex-row ms-lg-auto ms-0">
            ...
            {{-- <li class="nav-item dropdown">
                ...
                <b> <span id="notificationCount" class="count">&nbsp; {{ $messageCount }}</span>
                    <!-- Initial value here -->
                </b>
                    ...
                    <div class="user-profile-section">
                        <div class="media mx-auto">
                            ...
                            <div class="media-body">
                                ...
                                <p>{{ \Illuminate\Support\Facades\Auth::user()->designation ?? '' }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="dropdown-item">
