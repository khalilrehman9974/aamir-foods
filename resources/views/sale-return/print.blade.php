    ...
    <div class="container">
        ...
        <div class="info" style="margin-top: 1%;">
            <div class="row" style="margin-bottom: 3px;">
                <div style="width: 34%; text-align: left;">
                    <p><b>GRN NO:</b> <span>{{ $saleReturnMaster->grn_no }}</span></p>
                </div>
                <div style="width: 34%; text-align: right;">
                    <p><b> Sale Invoice#:</b> <span>{{ $saleReturnMaster->sale_invoice_number }}</span></p>
                </div>
                <div style="width: 30%; text-align: left;">
                    <p><b>Sale Return Invoice#:</b> <span>{{ $saleReturnMaster->id }}</span></p>
                </div>
            </div>
            <div class="row" style="margin-bottom: 3px;">
            ...
            <div class="row" style="margin-bottom: 3px;">
                ...
                <div style="width: 30%; text-align: right;">
                    <p><b>Bilty No:</b> <span>{{ $saleReturnMaster->bilty_no}}</span></p>
                </div>
            </div>
            <div class="row" style="margin-bottom: 3px;">
                <div style="width: 70%; text-align: left;">
                    <p><b>Driver Name:</b> <span>{{ $saleReturnMaster->driver_name }}</span></p>
                </div>
            </div>
        </div>
                ...
                <tbody>
                    @foreach ($saleReturnDetails as $saleReturnDetail)
                        <tr>
                            ...
                            <td>{{ $products[$saleReturnDetail->product_id] }}</td>
                            <td>{{ $saleReturnDetail->packing_type }}</td>
                            <td>{{ $saleReturnDetail->measurement_type }}</td>
                            <td>{{ $saleReturnDetail->quantity }}</td>
                            <td>{{ $saleReturnDetail->dzns }}</td>
                            <td>{{ $saleReturnDetail->total_dzns }}</td>
                            <td>{{ $saleReturnDetail->rate }}</td>
        ...
        <div class="row" style="display: flex;">
            <div class="notes" style="width: 50%;">
                <div>
                    <p><b>Remarks: </b> {{ $saleReturnMaster->remarks }}</p>
                </div>
            </div>
            <div class="totals" style="width: 20%;">
                <table>
                    <tbody>
                        <tr>
                            <th>Tot.Carton</th>
                            <td>{{ $saleReturnMaster->carton_amount ?? '0' }}</td>
                        </tr>
                        <tr>
                            <th>Tot.Boray</th>
                            <td>{{ $saleReturnMaster->boray_amount ?? '0'}}</td>
                        </tr>
            ...
            <div class="totals" style="width: 30%;">
                <table>
                    <tbody>
                        ...
                        <tr >
                            <th>Groos.Amount</th>
                            <td ><b>{{ $saleReturnMaster->gross_amount.'.00' ?? '0'}}</b></td>
                        </tr>
                        <tr >
                            <th>Offer/ Discount:</th>
                            <td ><b>{{ $saleReturnMaster->scheme ?? '0'}}</b></td>
                        </tr>
                        <tr >
                            <th>Commission</th>
                            <td ><b>{{ $saleReturnMaster->commission ?? '0'}}</b></td>
                        </tr>
                        <tr >
                            <th>Net.Amount</th>
                            <td ><b>{{ $saleReturnMaster->net_amount.'.00' ?? '0'}}</b></td>
                        </tr>
                    </tbody>
                </table>
            </div>
