    ...
    <div class="row layout-top-spacing">
        ...
        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
            <div class="row">
                ...
                <div class="col-lg-0 col-6 ">
                    <a href="{{ route('register') }}" class="btn btn-primary mt-2 mb-2 me-8" style="float : right; "
                        style="">Create
                    </a>
    ...
    <div class="row layout-top-spacing">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-9 filtered-list-search mx-auto">
                <form class="form-inline my-2 my-lg-0 justify-content-center" method="get" action="{{ route('users.list') }}">
                    <div class="w-100">
