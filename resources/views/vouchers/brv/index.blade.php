        ...
        <div id="tableCustomBasic" class="col-lg-12 col-12">
            ...
            <div class="statbox widget box box-shadow">
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>List Of Bank Receipt Vouchers</h4>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tr id="row_{{ $brv->id }}">
                                            ...
                                            <td class="text-center">
                                                <div class="action-btns">
                                                    ...
                                                    @endif
                                                    <a href="{{ route('brv.print', ['id' => $brv->id]) }}" target="_blank" title="Print"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-printer"><polyline points="6 9 6 2 18 2 18 9"></polyline><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"></path><rect x="6" y="14" width="12" height="8"></rect></svg></a>
