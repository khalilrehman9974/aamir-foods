                                                ...
                                                <div class="col-lg-12 col-12 ">
                                                    <form
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <a href="{{ route('brv.list') }}" style="float: right;"
    ...
    <script>
        document.getElementsByClassName('additem')[0].addEventListener('click', function() {
            ...
            let $html = '<tr>' +
                ...
                '<td class="title"><textarea id="description" type="text" name="description[]" value="{{ old('description', !empty($brv->description) ? $brv->description : '') }}" placeholder="Please Enter Description " class="form-control form-control-sm"></textarea></td>' +
                '<td class="text-right title"> <input id="debit" type="text" name="debit[]" value="{{ old('debit', !empty($brv->debit) ? $brv->debit : '') }}" placeholder="Amount " class="form-control form-control-sm"></td>' +
