        ...
        <div class="info" style="margin-top: 1%;">
            <div class="row" style="margin-bottom: 3px;">
                <div style="width: 70%; text-align: left;">
                    <p><b>Voucher #:</b> <span>{{ $brvMaster->id }}</span></p>
                </div>
                ...
                <tbody>
                    @foreach ($brvDetails as $brvDetail)
                        <tr>
                            ...
                            <td>{{ $party[$brvDetail->account_id] }}</td>
                            <td>{{ $banks[$brvDetail->bank_id] }}</td>
                            <td>{{ $brvDetail->description }}</td>
                            <td>{{ $brvDetail->amount }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
            ...
            <div class="totals" style="width: 37%;" >
                <table>
                    <tbody>
                        ...
                        <tr >
                            <th >Tot.Amount</th>
                            <td style="width: 15%;"><b>{{ $brvMaster->total_amount.'.00' ?? '0'}}</b></td>
                        </tr>
                    </tbody>
                </table>
            </div>
