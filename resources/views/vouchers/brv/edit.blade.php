    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('brv.create') }}">Create Voucher</a></li>
                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>Create Bank Receipt Voucher</h4>
                        </div>
                    </div>
                </div>
                                                            ...
                                                            <div class="invoice-detail-items"
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table item-table">
                                                                        ...
                                                                        <tbody>
                                                                            @if (!empty($brvDetails))
                                                                                @foreach ($brvDetails as $brvDetail)
                                                                                    <tr class="tr_clone validator_0">
                                                                                        ...
                                                                                        <td class="description">
                                                                                            <select id="party"
                                                                                                ...
                                                                                                @foreach ($dropDownData['accounts'] as $key => $value)
                                                                                                    <option
                                                                                                        value="{{ $key }}"
                                                                                                        {{ (old('account_id') == $key ? 'selected' : '') || (!empty($brvDetail->account_id) ? collect($brvDetail->account_id)->contains($key) : '') ? 'selected' : '' }}>
                                                                                                        {{ $value }}
                                                                                                    </option>
                                                                                                @endforeach
                                                                                            </select>
                                                                                            <textarea id="description" type="text" name="description[]" placeholder="Please Enter Description"
                                                                                                class="form-control form-control-sm mt-3">{{ $brvDetail->description }}</textarea>
                                                                                        </td>
                                                                                        <td class="title">
                                                                                            <select id="account_title"
                                                                                                ...
                                                                                                <option selected="">
                                                                                                    Please select the
                                                                                                    Party</option>
                                                                                                @foreach ($dropDownData['bankAccounts'] as $key => $value)
                                                                                                    <option
                                                                                                        value="{{ $key }}"
                                                                                                        {{ (old('account_id') == $key ? 'selected' : '') || (!empty($brvDetail->bank_id) ? collect($brvDetail->bank_id)->contains($key) : '') ? 'selected' : '' }}>
                                                                                                        {{ $value }}
                                                                                                    </option>
                                                                                                @endforeach
                                                                                            </select>
                                                                                        ...
                                                                                        <td class="bpvAmount">
                                                                                            <input type="text"
                                                                                                ...
                                                                                                value="{{ old('amount', !empty($brvDetail->amount) ? $brvDetail->amount : '') }}"
                                                                                                name="amount[]"
                                                                                                placeholder="Amount">
                                                                                        </td>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <input type="text" id="gross-amount"
                                                                                style="color: black;" value="{{$brv->total_amount ?? 0.00}}"
        ...
        <script>
            var config = {
                routes: {
                    ...
                    getDetailData: "{{ url('bpv/get-detail-data') }}",
                },
            }
