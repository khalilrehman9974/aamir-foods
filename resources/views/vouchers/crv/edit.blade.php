                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>Update Cash Receipt Voucher</h4>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="simple-pill">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                ...
                                <form action="{{ !empty($crv) ? route('crv.update') : route('crv.save') }}"
                                            ...
                                            <div class="table-responsive">
                                                <table class="table item-table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @if (!empty($crvDetails))
                                                            @foreach ($crvDetails as $crvDetail)
                                                                <tr class="tr_clone validator_0">
                                                                    ...
                                                                    <td class="description">
                                                                        <select id="party" name="account_id[]"
                                                                            ...
                                                                            @foreach ($dropDownData['accounts'] as $key => $value)
                                                                                <option value="{{ $key }}"
                                                                                    {{ (old('account_id') == $key ? 'selected' : '') || (!empty($crvDetail->account_id) ? collect($crvDetail->account_id)->contains($key) : '') ? 'selected' : '' }}>
                                                                                    {{ $value }}
                                                                                </option>
                                                                            @endforeach
                                                                        </select>
                                                                        <textarea id="description" type="text" name="description[]" placeholder="Please Enter Description"
                                                                            class="form-control form-control-sm mt-3">{{ $crvDetail->description }}</textarea>
                                                                    </td>
                                                                    <td class="title">
                                                                        <select id="account_title"
                                                                            ...
                                                                            @foreach ($dropDownData['cashAccount'] as $key => $value)
                                                                                <option value="{{ $key }}"
                                                                                    {{ (old('account_id') == $key ? 'selected' : '') || (!empty($crvDetail->cash_account_id) ? collect($crvDetail->cash_account_id)->contains($key) : '') ? 'selected' : '' }}>
                                                                                    {{ $value }}
                                                                                </option>
                                                                            @endforeach
                                                                        </select>
                                                                    ...
                                                                    <td class="bpvAmount">
                                                                        <input type="text" id="amount"
                                                                            ...
                                                                            value="{{ old('amount', !empty($crvDetail->amount) ? $crvDetail->amount : '') }}"
