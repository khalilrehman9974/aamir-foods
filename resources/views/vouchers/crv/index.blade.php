    ...
    <div class="row layout-top-spacing">
        ...
        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
            <div class="row">
                ...
                <div class="col-lg-0 col-6 ">
                    <a href="{{ route('crv.create') }}" class="btn btn-primary mt-2 mb-2 me-8" style="float : right; "
                        style="">Create
                    </a>
        ...
        <div id="tableCustomBasic" class="col-lg-12 col-12">
            <div class="row">
                <div class="col-lg-12" style="margin-right: 0px !important;">
                    ...
                    <form class="" method="get" action="{{ route('crv.list') }}">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2 ">
                                <span class="input-group-prepend" style="margin-top: 0px;">
                                    <a href="{{ route('crv.list') }}" class="btn btn-primary" value="Search"
            ...
            <div class="statbox widget box box-shadow">
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>List Of Cash Receipt Vouchers</h4>
                        </div>
                    </div>
                </div>
                <div class="widget-content widget-content-area">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @if ($vouchers)
                                    @foreach ($vouchers as $crv)
                                        <tr id="row_{{ $crv->id }}">
                                            <td>
                                                <div class="media">
                                                    <div class="media-body align-self-center">
                                                        <h6 class="mb-0">{{ $crv->id }}</h6>
                                            ...
                                            <td>
                                                <div class="media">
                                                    <div class="media-body align-self-center">
                                                        <h6 class="mb-0">
                                                            {{ \Carbon\Carbon::parse($crv->date)->format('d-m-Y') }}
                                                        </h6>
                                            ...
                                            <td>
                                                <div class="media">
                                                    <div class="media-body align-self-center">
                                                        <h6 class="mb-0">{{ $crv->total_amount }}</h6>
                                            ...
                                            <td class="text-center">
                                                <div class="action-btns">
                                                    @if ((!empty($permission->edit_access) && $permission->edit_access == 1) || Auth::user()->is_admin == 1)
                                                        <a href="{{ route('crv.edit', ['id' => $crv->id]) }}"
                                                    ...
                                                    @endif
                                                    <a href="{{ route('crv.print', ['id' => $crv->id]) }}" target="_blank" title="Print"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-printer"><polyline points="6 9 6 2 18 2 18 9"></polyline><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"></path><rect x="6" y="14" width="12" height="8"></rect></svg></a>
                                                    {{-- @if ((!empty($permission->delete_access) && $permission->delete_access == 1) || Auth::user()->is_admin == 1)
                                                        <a href="{{ route('crv.delete') }}"
