        ...
        <div class="info" style="margin-top: 1%;">
            <div class="row" style="margin-bottom: 3px;">
                <div style="width: 70%; text-align: left;">
                    <p><b>Voucher #:</b> <span>{{ $crvMaster->id }}</span></p>
                </div>
                ...
                <tbody>
                    @foreach ($crvDetails as $crvDetail)
                        <tr>
                            ...
                            <td>{{ $party[$crvDetail->account_id] }}</td>
                            <td>{{ $cashAccounts[$crvDetail->cash_account_id] }}</td>
                            <td>{{ $crvDetail->description }}</td>
                            <td>{{ $crvDetail->amount }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
            ...
            <div class="totals" style="width: 37%;" >
                <table>
                    <tbody>
                        ...
                        <tr >
                            <th >Tot.Amount</th>
                            <td style="width: 15%;"><b>{{ $crvMaster->total_amount.'.00' ?? '0'}}</b></td>
                        </tr>
                    </tbody>
                </table>
            </div>
