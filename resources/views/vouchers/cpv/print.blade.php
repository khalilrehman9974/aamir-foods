        ...
        <div class="info" style="margin-top: 1%;">
            <div class="row" style="margin-bottom: 3px;">
                <div style="width: 70%; text-align: left;">
                    <p><b>Voucher #:</b> <span>{{ $cpvMaster->id }}</span></p>
                </div>
                ...
                <tbody>
                    @foreach ($cpvDetails as $cpvDetail)
                        <tr>
                            ...
                            <td>{{ $party[$cpvDetail->account_id] }}</td>
                            <td>{{ $cashAccounts[$cpvDetail->cash_account_id] }}</td>
                            <td>{{ $cpvDetail->description }}</td>
                            <td>{{ $cpvDetail->amount }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
            ...
            <div class="totals" style="width: 37%;" >
                <table>
                    <tbody>
                        ...
                        <tr >
                            <th >Tot.Amount</th>
                            <td style="width: 15%;"><b>{{ $cpvMaster->total_amount.'.00' ?? '0'}}</b></td>
                        </tr>
                    </tbody>
                </table>
            </div>
