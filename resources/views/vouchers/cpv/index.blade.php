    ...
    <div class="row layout-top-spacing">
        ...
        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
            <div class="row">
                ...
                <div class="col-lg-0 col-6 ">
                    <a href="{{ route('cpv.create') }}" class="btn btn-primary mt-2 mb-2 me-8" style="float : right; "
                        style="">Create
                    </a>
        ...
        <div id="tableCustomBasic" class="col-lg-12 col-12">
            <div class="row">
                <div class="col-lg-12" style="margin-right: 0px !important;">
                    ...
                    <form class="" method="get" action="{{ route('cpv.list') }}">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2 ">
                                <span class="input-group-prepend" style="margin-top: 0px;">
                                    <a href="{{ route('cpv.list') }}" class="btn btn-primary" value="Search"
                                        ...
                                        <tr id="row_{{ $cpv->id }}">
                                            ...
                                            <td>
                                                <div class="media">
                                                    <div class="media-body align-self-center">
                                                        <h6 class="mb-0">
                                                            {{ \Carbon\Carbon::parse($cpv->date)->format('d-m-Y') }}
                                                        </h6>
                                            ...
                                            <td class="text-center">
                                                <div class="action-btns">
                                                    ...
                                                    @endif
                                                    <a href="{{ route('cpv.print', ['id' => $cpv->id]) }}" target="_blank" title="Print"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-printer"><polyline points="6 9 6 2 18 2 18 9"></polyline><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"></path><rect x="6" y="14" width="12" height="8"></rect></svg></a>
