                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>Create Cash Payment Voucher</h4>
                        </div>
                    </div>
                </div>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="title">
                                                                                        <select id="account_title_id"
                                                                                            ...
                                                                                            @foreach ($dropDownData['accounts'] as $key => $value)
                                                                                                <option
                                                                                                    value="{{ $key }}"
                                                                                                    {{ (old('account_title_id') == $key ? 'selected' : '') || (!empty($cpv->account_title_id) ? collect($cpv->account_title_id)->contains($key) : '') ? 'selected' : '' }}>
                                                                                                    {{ $value }}
                                                                                                </option>
                                                                                            @endforeach
                                                                                        </select>
                                                                                    ...
                                                                                    {{-- <td class="description">
                                                                                        <textarea id="description" type="text" name="description[]"
                                                                                            value="{{ old('description', !empty($cpv->description) ? $cpv->description : '') }}"
                                                                                    ...
                                                                                    <td class="text-right title">
                                                                                        <input id="debit"
                                                                                            type="text"
                                                                                            name="debit[]"
                                                                                            value="{{ old('debit', !empty($cpv->debit) ? $cpv->debit : '') }}"
                                                                                            placeholder="Amount "
                                                                                            class="form-control form-control-sm">
                                                                                    </td>
    ...
    <script>
        document.getElementsByClassName('additem')[0].addEventListener('click', function() {
            ...
            let $html = '<tr>' +
                ...
                '<td class="title"><select id="account_title_id" name = "account_title_id[]" class = "form-select form-control-sm" > <option selected = "" >Please select the Party </option> @foreach ($dropDownData['accounts'] as $key => $value) <option value = "{{ $key }}" {{ (old('account_title_id') == $key ? 'selected' : '') || (!empty($cpv->account_title_id) ? collect($cpv->account_title_id)->contains($key) : '') ? 'selected' : '' }}>{{ $value }} </option> @endforeach </select> </td>' +
                '<td class="title"><textarea id="description" type="text" name="description[]" value="{{ old('description', !empty($cpv->description) ? $cpv->description : '') }}" placeholder="Please Enter Description " class="form-control form-control-sm"></textarea></td>' +
                '<td class="text-right title"> <input id="debit" type="text" name="debit[]" value="{{ old('debit', !empty($cpv->debit) ? $cpv->debit : '') }}" placeholder="Amount " class="form-control form-control-sm"></td>' +
