    ...
    <script>
        document.getElementsByClassName('additem')[0].addEventListener('click', function() {
            ...
            let $html = '<tr>' +
                ...
                '<td class="title"><textarea id="description" type="text" name="description[]" value="{{ old('description', !empty($cpv->description) ? $cpv->description : '') }}" placeholder="Please Enter Description " class="form-control form-control-sm mt-0"></textarea></td>' +
                '<td class="text-right qty"> <input id="amount" type="text" name="amount[]" value="{{ old('debit', !empty($cpv->debit) ? $cpv->debit : '') }}" placeholder="Amount " class="form-control form-control-sm amount"></td>' +
