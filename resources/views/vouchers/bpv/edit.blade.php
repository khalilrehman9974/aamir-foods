                    ...
                    <div class="simple-pill">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                ...
                                <form action="{{ !empty($bpv) ? route('bpv.update') : route('bpv.save') }}"
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm"
                                                        name="date" id="date"
                                                        value="{{ $date }}" placeholder="Select The Date">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <table class="table item-table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="" style="width: 37%">Bank</th>
                                                            <th class="" style="width: 25%">Amount
                                                            </th>
                                                    ...
                                                    <tbody>
                                                        @if (!empty($bpvDetails))
                                                            @foreach ($bpvDetails as $bpvDetail)
                                                                <tr class="tr_clone validator_0">
                                                                    ...
                                                                    <td class="title">
                                                                        <select id="account_title" name="bank_id[]"
                                                                            ...
                                                                            @foreach ($dropDownData['bankAccounts'] as $key => $value)
                                                                                <option value="{{ $key }}"
                                                                                    {{ (old('account_id') == $key ? 'selected' : '') || (!empty($bpvDetail->bank_id) ? collect($bpvDetail->bank_id)->contains($key) : '') ? 'selected' : '' }}>
                                                                                    {{ $value }}
                                                                                </option>
                                                                            @endforeach
                                                                        </select>
                                                                    ...
                                                                    <td class="bpvAmount">
                                                                        <input type="text" id="amount"
                                                                            ...
                                                                            value="{{ old('amount', !empty($bpvDetail->amount) ? $bpvDetail->amount : '') }}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" id="gross-amount" style="color: black;"
                                                            ...
                                                            name="total_amount" id="gross-amount" value="{{$bpv->total_amount}}"
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 ">
                                                ...
                                                <button type="submit" style="float: right"
                                                    class="btn btn-success  rounded bs-popover ml-2 me-1 mt-5 mb-4 mr-5"
