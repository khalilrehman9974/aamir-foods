        ...
        <div class="info" style="margin-top: 1%;">
            <div class="row" style="margin-bottom: 3px;">
                <div style="width: 70%; text-align: left;">
                    <p><b>Voucher #:</b> <span>{{ $bpvMaster->id }}</span></p>
                </div>
                ...
                <tbody>
                    @foreach ($bpvDetails as $bpvDetail)
                        <tr>
                            ...
                            <td>{{ $party[$bpvDetail->account_id] }}</td>
                            <td>{{ $banks[$bpvDetail->bank_id] }}</td>
                            <td>{{ $bpvDetail->description }}</td>
                            <td>{{ $bpvDetail->amount }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
            ...
            <div class="totals" style="width: 37%;" >
                <table>
                    <tbody>
                        ...
                        <tr >
                            <th >Tot.Amount</th>
                            <td style="width: 15%;"><b>{{ $bpvMaster->total_amount.'.00' ?? '0'}}</b></td>
                        </tr>
                    </tbody>
                </table>
            </div>
