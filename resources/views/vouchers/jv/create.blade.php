    ...
    <script>
        document.getElementsByClassName('additem')[0].addEventListener('click', function() {
            ...
            let $html = '<tr>' +
                ...
                '<td class="description"><textarea id="description" type="text" name="description[]" value="{{ old('description', !empty($jv->description) ? $jv->description : '') }}" placeholder="Please Enter Description " class="form-control form-control-sm"></textarea></td>' +
                '<td class="text-right amount"> <input id="debit" type="text" name="debit[]" value="{{ old('debit', !empty($jv->debit) ? $jv->debit : '') }}" placeholder="Amount " class="form-control form-control-sm"></td>' +
                '<td class="text-right amount"> <input id="credit" type="text" name="credit[]" value="{{ old('credit', !empty($jv->credit) ? $jv->credit : '') }}" placeholder="Amount " class="form-control form-control-sm"></td>' +
