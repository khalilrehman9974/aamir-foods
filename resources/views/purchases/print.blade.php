        ...
        <div class="info" style="margin-top: 1%;">
            <div class="row" style="margin-bottom: 3px;">
                <div style="width: 34%; text-align: left;">
                    <p><b>GRN #:</b> <span>{{ $purchaseMaster->grn_no }}</span></p>
                </div>
                <div style="width: 34%; text-align: left;">
                    <p><b>Purchase Order #:</b> <span>{{ $purchaseMaster->purchase_order_no }}</span></p>
                </div>
                <div style="width: 30%; text-align: left;">
                    <p><b>Purchase Invoice #:</b> <span>{{ $purchaseMaster->id }}</span></p>
                </div>
            </div>
            ...
            <div class="row" style="margin-bottom: 3px;">
                <div style="width: 70%; text-align: left;">
                    <p><b>Supplier Bill#:</b> <span>{{ $purchaseMaster->supplier_bill_no }}</span></p>
                </div>
                <div style="width: 30%; text-align: right;">
                    <p><b>Unloaded By:</b> <span>{{ $purchaseMaster->unloaded_by }}</span></p>
                </div>
            </div>
            <div class="row" style="margin-bottom: 3px;">
                <div style="width: 70%; text-align: left;">
                ...
                <tbody>
                    @foreach ($purchaseDetails as $purchaseDetail)
                        <tr>
                            ...
                            <td>{{ $products[$purchaseDetail->product_id] }}</td>
                            <td>{{ $purchaseDetail->packing_type }}</td>
                            <td>{{ $purchaseDetail->measurement_type }}</td>
                            <td>{{ $purchaseDetail->size }}</td>
                            <td>{{ $purchaseDetail->bags }}</td>
                            <td>{{ $purchaseDetail->measurementType }}</td>
