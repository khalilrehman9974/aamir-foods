                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('purchase.list') }}">List</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                @foreach ($purchases as $purchase)
                                    <tr id="row_{{ $purchase->id }}">
                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="media-body align-self-center">
                                                    <h6 class="mb-0">{{ $purchase->grn_no }}</h6>
                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="media-body align-self-center">
                                                    <h6 class="mb-0">{{ \Carbon\Carbon::parse($purchase->date)->format('d-m-Y') }}</h6>
                                        ...
                                        <td class="text-center">
                                            <div class="action-btns">
                                                ...
                                                <a href="{{ route('purchase.print', ['id' => $purchase->id]) }}" target="_blank" title="Print"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-printer"><polyline points="6 9 6 2 18 2 18 9"></polyline><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"></path><rect x="6" y="14" width="12" height="8"></rect></svg></a>
