                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-0 col-4 ">
                                                                    ...
                                                                    <input id="po_no" type="number" name="purchase_order_no" style="color: black"
                                                                        value="{{$grnMaster->purchase_order_no}}"
                                                                        placeholder="PO No... "
                                                                ...
                                                                <div class="col-lg-0 col-4 ">
                                                                    ...
                                                                    <input id="grn_no" type="grn_no" name="grn_no"
                                                                        value="{{$grnMaster->id}}" style="color: black"
                                                                        placeholder="GRN No... "
                                                                        class="form-control {{ config('constants.css-classes.ELEMENT_SIZE_CLASS') }}"
                                                                        required readonly>
                                                                </div>
                                                                ...
                                                                <div class="col-lg-0 col-6 ">
                                                                    ...
                                                                    <select id="party_id" type="text"
                                                                        ...
                                                                        @foreach ($parties as $key => $value)
                                                                            <option value="{{ $key }}"
                                                                                {{ (old('party_id') == $key ? 'selected' : '') || (!empty($grnMaster->party_id) ? collect($grnMaster->party_id)->contains($key) : '') ? 'selected' : '' }}>
                                                                                {{ $value }}</option>
                                                                        @endforeach
                                                                    </select>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-0 col-6 ">
                                                                    ...
                                                                    <input id="supplier_bill_no" type="text" name="supplier_bill_no"
                                                                        value="{{ old('supplier_bill_no', !empty($grnMaster->supplier_bill_no) ? $grnMaster->supplier_bill_no : '') }}"
                                                                ...
                                                                <div class="col-lg-0 col-6 ">
                                                                    ...
                                                                    <select id="transporter_id" type="text"
                                                                        ...
                                                                        @foreach ($transporters as $key => $value)
                                                                            <option value="{{ $key }}"
                                                                                {{ (old('transporter_id') == $key ? 'selected' : '') || (!empty($grnMaster->transporter_id) ? collect($grnMaster->transporter_id)->contains($key) : '') ? 'selected' : '' }}>
                                                                                {{ $value }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    {{-- <div class="invalid-feedback">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-md-6 ">
                                                                    ...
                                                                    <input type="text" name="unloaded_by" style="color: black;"
                                                                        value="{{ old('unloaded_by', !empty($grnMaster->unloaded_by) ? $grnMaster->unloaded_by : '') }}"
                                                                                    ...
                                                                                    <tr class="tr_clone validator_{{ $index }}">
                                                                                        ...
                                                                                        <td class="product">
                                                                                            <select id="product_id" name="product_id[]"
                                                                                                ...
                                                                                                @foreach ($dropDownData['products'] as $key => $value)
                                                                                                    <option value="{{ $key }}"
                                                                                                        {{ (old('product_id') == $key ? 'selected' : '') || (!empty($grnDetail->product_id) ? collect($grnDetail->product_id)->contains($key) : '') ? 'selected' : '' }}>
                                                                                                        {{ $value }}
                                                                                                    </option>
                                                                                                @endforeach
                                                                                            </select>
                                                                                        ...
                                                                                        <td class="quantity">
                                                                                            <input type="text" style="color: black; "
                                                                                                ...
                                                                                                value="{{ old('measurement_type', !empty($grnDetail->measurement_type) ? $grnDetail->measurement_type : '') }}"
                                                                                        ...
                                                                                        <td class="quantity">
                                                                                            <input type="text" style="color: black;"
                                                                                                ...
                                                                                                placeholder="P.T"
                                                                                                value="{{ old('packing_type', !empty($grnDetail->packing_type) ? $grnDetail->packing_type : '') }}"
                                                                                                readonly>
                                                                                        </td>
                                                                                        <td class="quantity">
                                                                                            <input type="text" style="color: black;"
                                                                                        ...
                                                                                        <td class="quantity">
                                                                                            <input type="text" style="color: black;" id="quantity"
                                                                                                value="{{ old('quantity', !empty($grnDetail->received_qty) ? $grnDetail->received_qty : '') }}"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12" style="float: right;">
                                                                        <div style="width: 40%; float: right;">
                                                                            <label for="client-phone">Tot Qty:</label>
                                                                            <input type="text" style="color: black;"
                                                                            id="total_quantity" name="total_quantity" value=" {{$grnMaster->total_quantity}} "
                                                                            class="form-control {{ config('constants.css-classes.ELEMENT_SIZE_CLASS') }}"
                                                                            id="client-phone" placeholder="Tot.Qty" readonly>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12 align-self-center">
                                                                        ...
                                                                        <div class="form-group row invoice-note">
                                                                            ...
                                                                            <div class="col-sm-12">
                                                                                <textarea class="form-control" id="remarks" name="remarks" placeholder='Enter The Remarks' style="height: 88px;">{{ @$grnMaster->remarks }}</textarea>
                                                                            </div>
                                                                        </div>
