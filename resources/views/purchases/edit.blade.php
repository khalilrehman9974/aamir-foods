                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-0 col-4 ">
                                                                    ...
                                                                    <input id="po_no" type="number" name="purchase_order_no" style="color: black"
                                                                        value="{{$purchase->purchase_order_no}}"
                                                                        placeholder="PO No... "
                                                                ...
                                                                <div class="col-lg-0 col-4 ">
                                                                    ...
                                                                    <input id="grn_no" type="grn_no" name="grn_no"
                                                                        value="{{$purchase->grn_no}}" style="color: black"
                                                                        placeholder="GRN No... "
                                                                        class="form-control {{ config('constants.css-classes.ELEMENT_SIZE_CLASS') }}"
                                                                        required readonly>
                                                                </div>
                                                                ...
                                                                <div class="col-lg-0 col-4 ">
                                                                    ...
                                                                    <input id="invoice_no" type="number"
                                                                        value="{{$purchase->id}}" style="color: black"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-0 col-6 ">
                                                                    ...
                                                                    <input id="supplier_bill_no" type="text" name="supplier_bill_no"
                                                                        value="{{ old('supplier_bill_no', !empty($purchase->supplier_bill_no) ? $purchase->supplier_bill_no : '') }}"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-md-6 ">
                                                                    ...
                                                                    <input type="text" name="unloaded_by" style="color: black;"
                                                                        value="{{ old('unloaded_by', !empty($purchase->unloaded_by) ? $purchase->unloaded_by : '') }}"
                                                                                    ...
                                                                                    <tr class="tr_clone validator_{{ $index }}">
                                                                                        ...
                                                                                        <td class="quantity">
                                                                                            <input type="number" id="price"
                                                                                                name="price[]"
                                                                                                value="{{ old('price', !empty($purchaseDetail->price) ? $purchaseDetail->price : '') }}"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12" style="float: right;">
                                                                        <div style="width: 40%; float: right;">
                                                                            <label for="client-phone">Tot Qty:</label>
                                                                            <input type="text" style="color: black;"
                                                                            id="total_quantity" name="total_quantity" value=" {{$purchase->total_quantity}} "
                                                                            class="form-control {{ config('constants.css-classes.ELEMENT_SIZE_CLASS') }}"
                                                                            id="client-phone" placeholder="Tot.Qty" readonly>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12 align-self-center">
                                                                        ...
                                                                        <div class="form-group row invoice-note">
                                                                            ...
                                                                            <div class="col-sm-12">
                                                                                <textarea class="form-control" id="remarks" name="remarks" placeholder='Enter The Remarks' style="height: 88px;">{{ @$purchase->remarks }}</textarea>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4"
                                                                                ...
                                                                                <input type="text"
                                                                                    style="color: black;"
                                                                                    id="net-amount"
                                                                                    name="net_amount" value=" {{ $purchase->net_amount }} "
                                                                                    class="form-control {{ config('constants.css-classes.ELEMENT_SIZE_CLASS') }}"
