                    ...
                    <div class="page-meta">
                        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('co-inventory-sub-head.list') }}">Inventory Sub Heads List</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                <div class="col-lg-0 col-6 ">
                    <a href="{{ route('co-inventory-sub-head.create') }}" class="btn btn-primary mt-2 mb-2 me-8"
    ...
    <div class="row layout-top-spacing">
        <div id="tableCustomBasic" class="col-lg-12 col-12 layout-spacing">
            <div class="col-lg-8 col-md-8 col-sm-9 filtered-list-search mx-auto">
                <form method="get" action="{{ route('co-inventory-sub-head.list') }}" class="form-inline my-2 my-lg-0 justify-content-center">
                    <div class="w-100">
                ...
                <div class="widget-content widget-content-area">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <th scope="col" style="width: 60%"> <b>Sub Account Name </b> </th>
                                    ...
                                    <td>
                                        <div class="media">
                                            <div class="media-body align-self-center">
                                                <h6 class="mb-0">{{ $head->getMainAccountHead->name }}</h6>
                                    ...
                                    <td class="text-center">
                                        <div class="action-btns">
                                            @if ((!empty($permission->edit_access) && $permission->edit_access == 1) || Auth::user()->is_admin == 1)
                                                <a href="{{ route('co-inventory-sub-head.edit', ['id' => $head->id]) }}"
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-end">
                            {!! $subHeads->appends(request()->query())->links() !!}
                        </ul>
                    </nav>
                </div>
            </div>
