                ...
                <div class="row layout-top-spacing">
                    ...
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <div class="row">
                            ...
                            <div class="col-lg-0 col-6 ">
                                <a href="{{ route('co-inventory-detail-account.create') }}" class="btn btn-primary mt-2 mb-2 me-8"
                                                ...
                                                <td>
                                                    <div class="media">
                                                        <div class="avatar me-2">
                                                            <img alt="avatar" @if($account->image == null || !file_exists(base_path('resources/images/inventory/')  . $account->image))
                                                                src="{{ Vite::asset('resources/images/no-attachments.png')}}"
                                                                     @else
                                                                         src="{{ Vite::asset('resources/images/inventory/')  . $account->image}}"
                                                ...
                                                <td class="text-center">
                                                    <div class="action-btns">
                                                        @if ((!empty($permission->edit_access) && $permission->edit_access == 1) || Auth::user()->is_admin == 1)
                                                            <a href="{{ route('co-inventory-detail-account.edit', ['id' => $account->id]) }}"
...
{{--                                    @endif--}}
                ...
                <x-slot:footerFiles>
                    ...
                    <script>
                        var config = {
                            routes: {
                                deleteMainHead: "{{ url('co-inv-detail-account/delete') }}",
                            },
                        }
                    </script>
                    </x-slot>
