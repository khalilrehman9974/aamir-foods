...
class BillAgingController extends Controller
{
    ...
    //     $sales = $query->orderBy('date')->get()->groupBy('party_id');
    //     dd($sales);
    ...
    //     $query = SaleMaster::with(['area', 'belt', 'SaleMan', 'party','transporters'])->whereNull('deleted_at');
    ...
    //                 'transporter' => $invoice->transporters->name ?? 'qsqs',
    //                 'zone' => $invoice->zone->name ?? '',
    //                 'area' => $invoice->area->name ?? '',
